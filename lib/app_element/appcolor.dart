...
const Color primary1 = Color(0xFF06389B);
const Color primary2 = Color(0xFF1E88E5);
const Color primary3 = Color(0xFF1565C0);
...
const Color mediumGray = Color(0xFF808080);
